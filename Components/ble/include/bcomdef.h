...
//BLE USER NV Items -Range  0x80 - 0xFE
#define BLE_NVID_NAME_PARA              0x81  //保存蓝牙名称
#define BLE_NVID_BPS_PARA               0x82  //保存波特率   
#define BLE_NVID_ADVI_PARA              0x83  //保存广播间隔
#define BLE_NVID_CONI_PARA              0x84  //保存连接间隔
#define BLE_NVID_NAME_LEN               0x85  //保存蓝牙名称长度
#define BLE_NVID_PASSKEY_PARA           0x86  //保存配对密码
#define BLE_NVID_POWER_LEAVEL           0x87  //保存功率配置
